...
description: 'All my services would go in a messy "services" folder of unrelated behavior. All my React components would go in a massive "components" folder. I switched to vertical slice architecture (also known as feature-sliced architecture) and I''m never looking back!'
publishDate: '2023-01-02'
---

The day has arrived. We're starting a new software project! 🎉

After four hours of project configuration, we make our first move towards development:
...
For a small project, organizing by technical conern has turned out fine! It's not ideal, but our project is small enough that it's not much of a problem.
...
>
> Nope! You can apply this approach to whatever folder structure your heart desires.
...
A week passes, and John is now trying to understand how authentication works in our application. However, he is having trouble understanding all the pieces that make up our application's authentication. This is mostly due to how spread out authentication concepts are in our application:
...
Another week passes, and John is finally ready to fix a bug related to logging in. However, he is having trouble finding all the pieces related to login that need to change. Again, this is mostly due to how spread out login concepts are in our application:
...
> **Disclaimer**: I did not invent VSA! However, I have done tons of research on VSA and have applied it to my own applications.
>
...
>
> If you'd like to see another practice guide on applying VSA, check out this example on my YouTube channel where I convert a .NET application: [Vertical Slice Architecture](https://www.youtube.com/playlist?list=PLA8ZIAm2I03hFYKicAV9UBPeeJrDpT6r4)

## Going All In on Vertical Slice Architecture: An Example

Our team has decided that we really like John's VSA approach applied to the login behavior! We've decided to apply this concept to the rest of our application.
...
> Your feature folder names can also line up with the use cases that your application supports. For example, our application allows users to view a post, create a post, view their feed, and login. We can clearly see that from the feature folder names!
...
> Feel free to enforce whatever guidelines your team agrees on! This is just a practical example of how to achieve cohesiveness.

This is helpful, but how can our feed page reference the post component now? We'll need to add a layer above our feature modules: **pages**!
...
We can move these items to the most bottom layer: **shared**!
